...
class Ui_CalibrationDialog(object):
    def setupUi(self, CalibrationDialog):
        ...
        self.NewScale_rollbox.setMinimum(0.1)
        self.NewScale_rollbox.setMaximum(5.0)
        self.NewScale_rollbox.setProperty("value", 2.15)
    ...
    def retranslateUi(self, CalibrationDialog):
        ...
        self.nm0_edit.setText(_translate("CalibrationDialog", "422.8"))
